...
sensors like [Sony x1000v](https://www.sony.com/electronics/support/action-cam-fdr-x-series/fdr-x1000v/specifications) 1/2.3" sensor require over >1000 Lumens to minimize digital noise / grain </br>
...
but that method lowers Resolution: LinePairs/mm becoming a [12MegaPixel camera.](https://en.wikipedia.org/wiki/Sony_α7#Model_differences) </br>
Physical Pixel Pairs or "Digital Pixel Pairs" or both </br>
Physical Pixel pairs also increase phase error / pixel skew. </br>

Film Camera: </br>
most require a mirror, mirror creates vibrations, affecting Resolution: LinePairs/mm, </br>
